 ...
 */
package com.gws.android.tips.test.exception;
...
public class ErrorMessageFactoryTest extends AndroidTestCase {
  ...
  public void testNetworkConnectionErrorMessage() {
    String expectedMessage = getContext().getString(com.gws.android.tips.presentation.R.string.exception_message_no_connection);
  ...
  public void testUserNotFoundErrorMessage() {
    String expectedMessage = getContext().getString(com.gws.android.tips.presentation.R.string.exception_message_user_not_found);
